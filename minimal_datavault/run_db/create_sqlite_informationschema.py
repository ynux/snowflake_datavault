# If using sqlite, this acts as the information_schema.columns view of snowflake
from sqlalchemy import MetaData, Table, String, Column, select
from sqlalchemy.sql import text
from bin import helpers


def create_infoschema_columns(eng_infoschema):
    metadata = MetaData()
    sqlite_attach = ("attach database './metadata.db' as information_schema;")
    # caution: hardcoded db name here
    with eng_metadata.connect() as con_metadata:
        con_metadata.execute(sqlite_attach)
